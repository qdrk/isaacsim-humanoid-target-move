...
def compute_intermediate_values(
    ...
    # Direction aligns with initial direction reward: so it doesn't rotate around z.
    align_to_initial = torch.bmm(heading_vec.unsqueeze(1), basis_vec0.unsqueeze(2)).view(-1)
